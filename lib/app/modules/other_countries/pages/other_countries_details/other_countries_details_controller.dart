...
class OtherCountriesDetailsController extends GetxController {
  final MyCountryRepository repository;
  var country = Get.arguments;
  ...
  OtherCountriesDetailsController({@required this.repository});
  String countryFlag = '';

  @override
  void onInit() {
    getMyCountry();
    print('OtherCountriesDetailsController onInit');
    super.onInit();
  }
  ...
  String translateCountryList() {
    String translate = '';
    _countryDetailsList.where((element) {
      if (element.locale.en == (myCountryList[0].country)) {
        translate = element.locale.pt;
      }
      return element.locale.en
          .toLowerCase()
          .contains(myCountryList[0].country ?? 'Brazil');
    }).toList();
    return translate.isNotEmpty ? translate : myCountryList[0].country;
  }
  ...
  @override
  void dispose() {
    print('OtherCountriesDetailsController Dispose');
    super.dispose();
  }
